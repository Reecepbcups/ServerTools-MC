...
public class ConfigUpdater {
    ...
    public static void update(Plugin plugin, String resourceName, File toUpdate, List<String> ignoredSections) throws IOException {
        ...
        // add these to the config file in a string list?
        ignoredSectionsArrayList.add("Cooldowns");
        ignoredSectionsArrayList.add("Misc.CMDAliases.cmds");
        ignoredSectionsArrayList.add("Misc.CMDAliases.disabledWorlds");
        ignoredSectionsArrayList.add("Misc.CMDAliases.preCooldownCommands");
        ignoredSectionsArrayList.add("Bungee.BungeeServerCMD.Aliases");        
        ignoredSectionsArrayList.add("Commands.StaffList.groups"); 
        ...
        ignoredSectionsArrayList.add("PluginVariables");
